    ...
    <!-- <i class="fa fa-eye"></i> --> <input type="password"  class="form-control showprofile" id="email" name="email" readonly  
                ...
                <tr>
                    <th scope="row">Mobile Number</th>
                        <td><input type="text" class="form-control showprofile" id="mobile" name="mobile" readonly 
                  value="<?php echo "$getuserdetails->mobile"?>"></td>
                </tr>

                <tr>
                    <th scope="row">Website</th>
                    <td><input type="text" class="form-control showprofile" id="mobile" name="website" readonly 
       ...
       <?php foreach ($getstaffdetails as $key => $value) {
         ...
         <tr>
           ...
           ?>"></td>
              ...
              <td><input type="email" class="form-control showprofile1" id="email1" name="email1" readonly  value="<?php echo "$value->email"?>"></td>
