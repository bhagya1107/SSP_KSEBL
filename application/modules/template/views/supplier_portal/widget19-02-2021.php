  ...
  <div class="vertical-menu quick-menu  ">
        ...
        <span aria-hidden="true">&times;</span>
			...
			<ul class="nav nav-tabs">
				<li class="nav-item active col-sm-7" style="text-align: center;padding-right:0px;"> <a data-toggle="tab" href="#home">Quick Links</a></li> </li>
				<li class="nav-item "> <a data-toggle="tab" href="#home">Notifications</a></li></li>
    ...
    <div class="tab-content mt-3">
        ...
        <br>
                ...
                <a style="<?php if($getcompanypermissiondetails->tenders=='0') echo "display: none;" ?>"  href="<?=supplier_url('tenders/my')?>">Favorite Tenders<i></i></a>
                ...
                <a style="<?php if($getcompanypermissiondetails->tenders=='0') echo "display: none;" ?>"  href="<?php echo base_url("supplier/delivery/delivery_module") ?>">View Calender</a><i></i></a>
                ...
                <a href="#" class=""><b>ADMINISTRATION</b></a><hr>
                        ...
                        <a href="<?=supplier_url('dashboard/portfolio')?>" style="<?php if($user_type=='2' OR $user_type=='4' OR $user_type=='5' OR $user_type=='6') echo "display: none;" ?>">Company Portfolio</a>
