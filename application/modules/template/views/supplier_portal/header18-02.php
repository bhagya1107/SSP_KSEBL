									...
									<div class="tg-colhalf pull-right">
										...
										<nav class="tg-addnav pull-right" >
											...
											<ul >
												...
												<li title="Quick Links"  class="quicklinkheader " data-toggle="collapse" href="#multiCollapseExample1"  id="toggle-button"><a href="#"><i class="fa fa-th" aria-hidden="true" style="color:#fff" onclick=""></i></a></li>
												<li title="notifications"  ><a href="<?=supplier_url('dashboard/notifications')?>"><i class="fa fa-bell" aria-hidden="true" style="color:#fff"></i></a></li>
