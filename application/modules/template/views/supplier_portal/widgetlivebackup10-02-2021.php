  ...
  <div class="vertical-menu quick-menu  ">
    ...
    <div class="clearfix"></div><br><br>
            <ul class="nav nav-tabs nav-line nav-color-secondary" role="tablist">
				<li class="nav-item active col-sm-7" style="text-align: center;"> <a class="nav-link active show" data-toggle="tab" href="#messages" role="tab" aria-selected="true">Quick Links</a> </li>
