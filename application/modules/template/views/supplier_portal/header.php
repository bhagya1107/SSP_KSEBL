		...
		<header id="tg-header" class="tg-header tg-haslayout">
			...
			<div class="col-md-1">
				<ul class="tg-socialicons">
					...
					<!-- <li><img src="<?=base_url()?>assets/default-avatar.png" style="height:30px;width:30px;border-radius:50%"></li> -->
				</ul>
			</div>
			<div class="container">
						...
						<div class="tg-topbar tg-haslayout">
							<nav id="tg-topaddnav" class="tg-topaddnav">
								...
								<div id="tg-addnavigationm-mobile" class="tg-addnavigationm-mobile collapse navbar-collapse">
										...
										<nav class="tg-addnav pull-right" >
											...
											<ul >
												<li title="fontsize"  ><a href="#">
													<i class="fa fa-font changefont" aria-hidden="true"  data-name='12px' title="small" style="color:#fff;font-size:8px;"></i>&nbsp;
									...
									<!-- <nav class="tg-addnav pull-right usernamecls" >
									<ul>
										<li><a href="#"><img src="<?=base_url()?>assets/default-avatar.png" alt="image description" width="30px"></a></li>
									</ul>
                 ...
                 <div class=""  > <style type="text/css">
                                ...
                                <div class="">
									<ul> -->
										...
										<li  style="<?php if($getcompanypermissiondetails->delivery=='0') echo "display: none;" ?>"><a  href="<?=supplier_url('delivery')?>">Delivery </a></li>
										<li  style="<?php if($getcompanypermissiondetails->accounts=='0') echo "display: none;" ?>"><a  href="<?=supplier_url('accounts/payments')?>">Accounts</a></li>
										<li  style="<?php if($getcompanypermissiondetails->work_measurement=='0') echo "display: none;" ?>"><a  href="#s!">Work Measurement</a></li>
