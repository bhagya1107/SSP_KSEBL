		...
		<div id="tg-navigationm-mobile" class="tg-navigationm-mobile tg-navigation collapse navbar-collapse">
			...
			<div class="tg-colhalf">
				...
				<ul>
                    ...
                    <li style="<?php if($getcompanypermissiondetails->tenders=='0') echo "display: none;" ?>"><a  href="<?=supplier_url('tenders')?>">Tenders</a></li> 
							...
							<nav id="tg-topaddnav" class="tg-topaddnav">
								...
								<div id="tg-addnavigationm-mobile" class="tg-addnavigationm-mobile collapse navbar-collapse">
									<div class="tg-colhalf pull-right">
										<nav class="tg-addnav custom-menu">
											<ul>
												 <?php   
                									$user_type=$this->session->userdata('user_type');
										...
										<nav class="tg-addnav pull-right" >
											...
											<ul >
												...
												<a  href="<?=site_url('supplier/dashboard/supplier_administration/#tab_9')?>">
									...
									<div class="tg-colhalf">
										...
										<ul class="tg-socialicons custom-menu">
