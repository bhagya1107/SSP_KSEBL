			...
			foreach ($form_questions['question'] as $key => $value) {
				...
				if($form_questions['option_list'][$key]){
					...
					if($inputtype =='textarea'){
						$dataAppend.="<div class='form-group col-md-8'><textarea class='form-control' name='$questionId' id='$questionId'>$answerss</textarea></div>
						</div>";
					}else{
						$dataAppend.="	<div class='form-group col-md-8'>
									<input type='$inputtype' id='$questionId' class='form-control' required name='$questionId' value='$answerss'>
									</div>
							</div>";
					}
				}
