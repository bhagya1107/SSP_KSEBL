		...
		<div class="container">
			...
			<div class="col-sm-11 col-xs-11 pull-right">
				<ul class="nav nav-tabs">
					...
					<li class="<?php echo $tab ==2 ? "active" : "" ?>"><a data-toggle="tab" href="#menu1">Favorite Tenders</a></li>
								...
								<div class="tg-ticket">
                                   ...
                                   <span><?php $time=strtotime($tenders->tender_date);
									...
									<div class="tg-btnsbox" style="margin-top:11px;">
										...
										<a class="btn btn-primary btn-sm" href="<?php echo base_url("supplier/tenders/apply/1") ?>">Add to Favorite </a>
							...
							<div class="tg-tickets">
								<div class="tg-ticket">
									...
									<div class="tg-matchdetail">
										...
										<h4>Favorite Tender Name 1</h4></h4>
										<ul class="tg-matchmetadata">
								...
								<div class="tg-ticket">
									...
									<div class="tg-matchdetail">
										...
										<h4>Favorite Tender Name 2</h4></h4>
										<ul class="tg-matchmetadata">
											<li><address>Tender Short Description</address></li>
										</ul>
									</div>
