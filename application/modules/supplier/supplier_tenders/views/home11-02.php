								...
								<div class="tg-ticket">
                                   ...
                                   <span><?php $time=strtotime($tenders->tender_date);
									...
									<div class="tg-btnsbox" style="margin-top:11px;">
										...
										<a class="btn btn-primary btn-sm" href="<?php echo base_url("supplier/tenders/apply/1") ?>">Add to Favourite </a>
							...
							<div class="tg-tickets">
								<div class="tg-ticket">
									...
									<div class="tg-matchdetail">
										...
										<h4>Favourite Tender Name 1</h4></h4>
										<ul class="tg-matchmetadata">
								...
								<div class="tg-ticket">
									...
									<div class="tg-matchdetail">
										...
										<h4>Favourite Tender Name 2</h4></h4>
										<ul class="tg-matchmetadata">
											<li><address>Tender Short Description</address></li>
										</ul>
									</div>
