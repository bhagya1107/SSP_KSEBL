		...
		<div class="row">
			<div id="tg-twocolumns" class="tg-twocolumns tg-main-section tg-haslayout">
				<div class="col-md-9 col-sm-8 col-xs-12 pull-right">
					<?php $created_date=$getsubscriptionstatus->created_date;
						...
						<div class="table-responsive">
							<table class="table table-bordered table-hover">
								<tr>
									<td style="text-align:right"><b> Your Subscription Status is Active until</b> 	</td>
									<td> 
                           
                           <input type="text" name="" value="<?php echo $newEndingDate;?>">
                       </td>
								</tr>
					...
					<td>
						<input type="text" name="" value="<?php echo $created_date1;?>">
							</td>
								</tr>
							
								<tr>
									<td style="text-align:right">Renewal Date</td>
									<td><input type="text" name="" value="<?php echo $newEndingDate;?>"> </td>
