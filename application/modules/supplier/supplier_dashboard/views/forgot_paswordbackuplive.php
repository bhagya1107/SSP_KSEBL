                    ...
                    $atributes=array('class'=>'md-float-material form-material','id'=>'frm', 'name'=>'frm' ,'autocomplete'=>'off');
                     ...
                     ?>
                            <!--<div class="text-center scale-up-center ">
                                <img src="<?=base_url()?>assets/logo2.png" alt="image description" width="30px">
                            </div>-->
                                ...
                                <div class="card-block scale-up-center">
                                    ...
                                    <div class="form-group form-primary" id="email_block">
                                      <label>Enter your Registered Mobile No</label>
                                        <input type="Mobile No" name="Mobile No" id="Mobile No" class="form-control" required="" placeholder="Enter your registered Mobile No" autocomplete="off">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12" id="gtop">
                                            ...
                                            <button type="button" onkeyup="check()";  class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">GET OTP</button><span style= "color:red;" id="paswordmess" class="hide">Password sent to your registered mobile number</span>
                                        </div>
                                        <div class="col-md-12" id="chgpwd" style="display:none">
                                            <button type="button" onclick="()" id="btn" class="btn btn-info btn-md btn-block waves-effect waves-light text-center m-b-20">RESET PASSWORD</button>
                                        </div>
                                    </div>
