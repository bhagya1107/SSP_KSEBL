				...
				<div class="col-md-9 col-sm-8 col-xs-12 pull-right">
                  ...
                  <?php if($getcompanydetails->incorporationno=='')
									...
									<td><input type="text"  class="form-control showprofile"  id="incorporation" name="incorporation" readonly value="<?php echo $getcompanydetails->incorporationno;?>"/>	</td>
                                                                  <?php } ?>
									<td><label  class="choose-file hide " id="b">pdf up to 10mb</label><input id="file0"  onchange="validatePDF(this)" accept = "application/pdf" type="file" name="file1"  class="form-control choose-file hide " value=""/>
                 ...
                 <?php if($getcompanydetails->incorporationdate=='') {?>
                  ...
                  <?php } ?>
								...
								<td style="text-align:right">Authorized Person	</td>
									...
									<td ><label  class="choose-file hide " id="c">pdf up to 10mb</label><input id="file1" onchange="validatePDF(this)" accept = "application/pdf" type="file" name="file3" class="form-control showprofile choose-file hide"  value="doc.img"/>
