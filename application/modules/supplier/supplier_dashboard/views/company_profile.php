				...
				<div class="col-md-9 col-sm-8 col-xs-12 pull-right">
						...
						<div class="table-responsive">
                            ...
                            <button type="submit" class="tg-btn pull-center editbutton" id="editprofilefn" style="margin-left:690px;" data-nlok-ref-guid="727bd987-58f0-47cd-f295-b92298e95987" ><span>Edit</span></button>
                               <button type="submit" class="tg-btn pull-center savebutton hide"  onclick="save_companydetails();" id="saveprofilefn" style="margin-left:443px;" data-nlok-ref-guid="727bd987-58f0-47cd-f295-b92298e95987"><span>Save</span></button>
