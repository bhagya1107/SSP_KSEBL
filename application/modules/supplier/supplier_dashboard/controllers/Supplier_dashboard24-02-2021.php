...
public function updatePassword()
{
	...
	public function getEmployeesListData() {
		...
		$uid=$this->session->userdata('uid');
	        ...
	        $edit ='<a href="javascript:void(0);" id="editprofilefn"> <span style="color:blue"><i class="fa fa-pencil" id="edit-supplier" aria-hidden="true"></i></span></a>';
			...
			{
				$status='<a href="javascript:void(0);"><span style="color:SlateBlue"><i class="fa fa-unlock" id="lock-supplier" aria-hidden="true"></i></span></a>';
			}
