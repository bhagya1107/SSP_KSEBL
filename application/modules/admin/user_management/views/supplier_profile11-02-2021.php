    ...
    <div class="pcoded-inner-content">
                                ...
                                <div class="tab-header card">
                                    <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist" id="mytab">
                                        <li class="nav-item" style="width: 200px;">
                                            <a class="nav-link active" data-toggle="tab" href="#personal" role="tab">Supplier Info</a>
                                            <div class="slide" style="width: 200px;"></div>
                                        </li>
                                         <li class="nav-item" style="width: 200px;">
                                            <a class="nav-link" data-toggle="tab" href="#portfolio" role="tab">Supplier Portfolio</a>
                                            <div class="slide" style="width: 200px;"></div>
                                        </li> 
                                        <li class="nav-item" style="width: 200px;">
                                        ...
                                        <li class="nav-item" style="width: 200px;">
                                            <a class="nav-link" data-toggle="tab" href="#contacts" role="tab">Staff Details</a>
                                            <div class="slide" style="width: 200px;"></div>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="tab-pane active" id="personal" role="tabpanel">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <button id="editprofilefn"  type="button" class="btn btn-sm btn-primary waves-effect waves-light f-right editbutton">
     ...
     <table class="table m-0">
        ...
        <tr>
            ...
            <td><input type="text" class="form-control showprofile" id="address" name="created_date" readonly 
                  value="Test Address"></td>
        </tr>
        <tr>
    ...
    <div class="table-responsive">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><input type="password" class="form-control showprofile" id="email" name="created_date" readonly 
                  value="<?php echo "$getuserdetails->email"?>" onclick="viewemail()"></td>
                </tr>
                <tr>
                    <th scope="row">Mobile Number</th>
                        <td><input type="text" class="form-control showprofile" id="mobile" name="created_date" readonly 
                  value="<?php echo "$getuserdetails->mobile"?>"></td>
                </tr>

                <tr>
                    <th scope="row">Website</th>
                    <td><input type="text" class="form-control showprofile" id="website" name="created_date" readonly 
                  value="<?php echo "$getcompanydetails->website"?>"></a></td>
                </tr>
               <!--  <tr>
                ...
                <tr>
                  ...
                  value="<?php echo "$getuserdetails->password"?>" onclick="viewpassword()"></td>
                </tr>
                <tr>
                    <th></th>
                    <td> <div class="form-group"><button type="submit" class="btn btn-primary savebutton hide"  onclick="save_profiledetails();" id="saveprofilefn"  data-nlok-ref-guid="727bd987-58f0-47cd-f295-b92298e95987"><span>Save</span></button>
                        <button type="submit" class="btn btn-primary"  id=""  data-nlok-ref-guid="727bd987-58f0-47cd-f295-b92298e95987"><span>Cancel</span></button></div></td>

                      <!--   <button type="submit" class="tg-btn pull-center " id="editprofilefn" style="margin-left:243px;" data-nlok-ref-guid="727bd987-58f0-47cd-f295-b92298e95987"><span>Edit</span></button>
                                                              ...
                                                              <tbody>
                                                                <tr>
                                                                  <th scope="row">Category  </th>
                                                                   ...
                                                                   <th scope="row">Defects </th>
                                                                   <th scope="row">VMI </th>
                                                                </tr>
                                                                  <tr>
                                                                     <td>Distribution</td>
                                                                      <td>DIST TFR 3PH 50 kVA 11kV/415V ONAN</td>
                                                                      <td>2</td> 
                                                                      <td>2</td>
                                                                      <td>1</td>
                                                                      <td>1</td> 
       ...
       <?php foreach ($getstaffdetails as $key => $value) {
                       ...
                       ?>
         <tr>
             <td><input type="text" class="form-control showprofile1" id="staffname" name="staffname"  value="<?php echo "$value->name"?>" readonly>
              <input type="hidden" class="form-control showprofile1" id="id" name="id"  value="<?php echo "$value->id"?>" ></td> 
             <td>
           ...
           ?>"></td>
              <td><input type="text" class="form-control showprofile1" id="mobilenum1" name="mobilenum1" readonly 
                  value="<?php echo "$value->mobilenum"?>"></td>
              <td><input type="text" class="form-control showprofile1" id="email1" name="email1" readonly  value="<?php echo "$value->email"?>"></td>
                                                          ...
                                                          <tr>
                                                              <td>
                                                                  ...
                                                                  <div class="d-inline-block align-middle">
                                                                      <h6><?php echo $getcompanydetails->document?></h6>
                                                                      <p class="text-muted m-b-0"></p>
                                                                  </div>
                                                              </td>
                                                              <td><?php echo $getcompanydetails->document_submited_date?></td>
                                                              <td><button class="btn btn-danger"><i class="icofont icofont-eye-alt"></i></button></td>
