                                    ...
                                    <div class="tab-pane active" id="personal" role="tabpanel">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <button id="editprofilefn"  type="button" class="btn btn-sm btn-primary waves-effect waves-light f-right editbutton editprofilefn">
               ...
               <!--  <tr>
                ...
                <tr>
                    ...
                    <td > <div class="form-group"><button type="submit" class="btn btn-primary formdisplay form1"  onclick="save_profiledetails();" id="saveprofilefn"  data-nlok-ref-guid="727bd987-58f0-47cd-f295-b92298e95987"  ><span>Save</span></button>
                        <button type="submit" class="btn btn-primary formdisplay form1"   data-nlok-ref-guid="727bd987-58f0-47cd-f295-b92298e95987" ><span>Cancel</span></button></div></td>
                                                  ...
                                                  <table class="table table-hover  table-borderless">
                                                      ...
                                                      <tbody>
                                                          <tr>
                                                              ...
                                                              <td> <button class="btn btn-danger"> <a  href="<?php echo base_url('uploads/Doc1.pdf')?>"  target="_blank"><i class="icofont icofont-eye-alt"></i> </a></button></td>
