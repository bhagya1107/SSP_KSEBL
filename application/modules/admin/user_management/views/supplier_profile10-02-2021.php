<div class="pcoded-content">
    <div class="pcoded-inner-content">
                                    ...
                                    <div class="tab-pane active" id="personal" role="tabpanel">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <button id="editprofilefn" type="button" class="btn btn-sm btn-primary waves-effect waves-light f-right">
     ...
     <table class="table m-0">
        ...
        <tr>
             <th scope="row">Contact Perosn</th>
    ...
    <div class="table-responsive">
            <table class="table">
                ...
                <tr>
                  ...
                  value="<?php echo "$getuserdetails->email"?>" onclick="viewdata()"></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  value="<?php echo "$getuserdetails->password"?>" onclick="viewdata()"></td>
                </tr>
                <tr>
                    <th></th>
                    <td><button type="submit" class="btn btn-primary"  onclick="save_profiledetails();" id="saveprofilefn"  data-nlok-ref-guid="727bd987-58f0-47cd-f295-b92298e95987"><span>Save</span></button>
</td>
                </tr>
            </tbody>
        </table>
         ...
         <tr>
           ...
           ?>"></td>
              ...
              <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
                  <a class="dropdown-item" id="editprofilefn1"><i class="icofont icofont-edit"></i>Add Details</a>
                  <a class="dropdown-item" id="delete_staffdetail"><i class="icofont icofont-ui-delete"></i>Delete Visit</a>
                                                          ...
                                                          <tr>
                                                              <td>
                                                                  ...
                                                                  <div class="d-inline-block align-middle">
                                                                      <h6>GST Document</h6>
                                                                      <p class="text-muted m-b-0">GST Details</p>
                                                                  </div>
                                                              </td>
                                                              <td>21/08/2020</td>
