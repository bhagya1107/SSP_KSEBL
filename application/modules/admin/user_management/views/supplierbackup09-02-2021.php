                    ...
                    <tbody id="div2">
                      ...
                      <?php foreach ($getuserdetails as $key => $value) {
                       ...
                       <tr>
                        ...
                        <td><a href="<?php echo base_url('webuser/User_management/activate_account/'.$value->uid)?>" ><input type="button"   class="btn  btn-sm btn-out-dashed btn-success btn-square" value="Activate"  onclick="confirm('Are you sure to Activate')" /></a></td>
                        <td>
  ...
  function refreshTable(){
    ...
    $.ajax({
      ...
      success:function(result)
      {
        var tab='';
        var j=1;
        // var cnf = confirm("Are you sure to activate?"); 
        $.each( result, function(i, data){
          tab=tab+'<tr> <td>'+j+'</td> <td class="tbllength">'+data.name+'</td> <td>'+data.created_date+'</td> <td>'+data.pannumber+'</td> <td>'+data.mobile+'</td> <td>'+data.email+'</td> <td>'+data.user_type+'</td> <td>';
